...
export const SKIPPED_TUI_TESTS = [
	{
		...
		reason: "test.fail for a known focus bug is flaky under parallel full-suite runs; passes in isolation but times out when run with other tests",
	},
	{
		test: "plan-to-ferment-promo",
		reason: "test.fail for a known dropdown/buffer bug is flaky under parallel full-suite runs; passes in isolation but fails with assertion errors when run with other tests",
	},
	{
		test: "ask-user-form",
