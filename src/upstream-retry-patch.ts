...
const RETRYABLE_NETWORK_ERROR_RE =
	/\b524\b|cloudflare.*timeout|timeout.*cloudflare|idle timeout|timed out after|socket connection was closed|unexpectedly|EPIPE|ERR_SOCKET_CLOSED|ERR_STREAM_PREMATURE_CLOSE|ECONNRESET|connection reset/i
