...
/**
 * Persist-on-change delivery of the ferment lifecycle state block. Shared
 * persistence handles dedupe, busy-run deferral, settle flush, history replay
 * dedupe, and the strip-only context view. Ferment remains responsible only
 * for rendering state and subscribing to lifecycle transitions.
 */
