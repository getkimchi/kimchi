...
function buildAgentsSection(): string {
	...
	return `\n\n**Available subagent types (when delegating, pick by step intent):**\n${lines.join("\n")}`
}

export function buildPlannerSupplement(f: Ferment, continuationPolicy: ContinuationPolicy, isOneshot = false): string {
