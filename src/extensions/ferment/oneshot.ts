...
2. **For each phase**, call activate_ferment_phase, then for each step:
   ...
   - spawn an Agent worker with the exact task_ref returned by start_ferment_step and explicit max_turns and max_duration — always set both, using the suggested limits as the default
