...
describe("todo prompt block", () => {
	...
	it("renders guidance without a current list", () => {
		...
		expect(block).toContain("supported types are text, confirm, single, and multi")
		expect(block).toContain("call the real questionnaire tool with those questions before stopping")
