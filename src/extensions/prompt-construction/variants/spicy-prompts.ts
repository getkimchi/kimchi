...
- Before starting any non-trivial work, clarify the scope and confirm it with the requester.
...
- Never commit, push, publish, or comment on shared resources (pull requests, issue trackers, shared branches) unless explicitly asked to. Keep commits small and human-looking.
