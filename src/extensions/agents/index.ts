...
- Explore is read-only and should return decision-ready findings to you. Do not ask Explore agents to write reports, create docs, edit files, save findings to disk, or produce polished artifacts. The parent orchestrator should consume the returned findings directly and decide the next step.
