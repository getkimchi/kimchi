...
import codexHooksAdapter from "../codex-hook-adapter/index.js"
...
describe("hook adapter command execution", () => {
	...
	it("mutates Codex PreToolUse input and delivers additional context", async () => {
		writeJson(join(dir, "project", ".codex", "hooks.json"), {
			hooks: {
	...
	it("sends a follow-up message when a Stop hook requests continuation", async () => {
