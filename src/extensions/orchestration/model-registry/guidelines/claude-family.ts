/**
 * Claude family role-guideline overrides.
 *
 * Sourced from:
...
export const CLAUDE_FAMILY_PLAN = `When planning (Claude family):
...
export const CLAUDE_FAMILY_EXPLORE = `When exploring (Claude family):
...
export const CLAUDE_FAMILY_REVIEW = `When reviewing (Claude family):
...
export const CLAUDE_OPUS_46_PLAN = `When planning (claude-opus-4-6 specific):
