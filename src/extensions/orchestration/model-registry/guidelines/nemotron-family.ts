...
export const NEMOTRON_FAMILY_RESEARCH = `When researching (Nemotron family):
...
export const NEMOTRON_FAMILY_BUILD = `When implementing (Nemotron family):
...
export const NEMOTRON_3_ULTRA_EXPLORE = `When exploring (nemotron-3-ultra-fp4 specific):
...
export const NEMOTRON_3_ULTRA_RESEARCH = `When researching (nemotron-3-ultra-fp4 specific):
...
export const NEMOTRON_3_ULTRA_BUILD = `When implementing (nemotron-3-ultra-fp4 specific):
