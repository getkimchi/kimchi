...
Optionally call \`set_phase\` to tag the current type of work for analytics. Use one of \`explore\`, \`research\`, \`plan\`, \`build\`, or \`review\`. Only one phase is active at a time — the most recent call wins.`
