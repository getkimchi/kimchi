...
export const DEFAULT_COUNCIL_CONFIG: CouncilConfig = {
	...
	budget: {
		maxLogicalCalls: 24,
		maxPhysicalAttempts: 36,
		maxConcurrentCalls: 3,
		maxAggregateInputTokens: 1_572_864,
		maxAggregateOutputTokens: 262_144,
...
const PRESET_LIMITS = {
	...
	normal: {
		...
		maxConcurrentCalls: 3,
		maxAggregateInputTokens: 1_048_576,
		maxAggregateOutputTokens: 196_608,
...
export function applyCouncilPreset(config: CouncilConfig, preset: CouncilPreset): CouncilConfig {
	...
	return validateCouncilConfig({
		...config,
		reviewPolicy: limits.reviewPolicy,
		requiredRoles,
