...
import { DEFAULT_COUNCIL_TRANSACTION_LIMITS } from "./transaction-runtime.js"
...
export type CandidatePatchOperation = CandidatePatch["operations"][number]

export type CandidatePatchFailureCode = "invalid_patch" | "path" | "base_drift" | "limits" | "transaction"
...
export interface StagePatchFailure {
	ok: false
...
export type StagePatchResult = StagePatchSuccess | StagePatchFailure

export interface RenderPatchDiffOptions {
	maxBytes?: number
}
