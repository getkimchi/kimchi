...
export const CLAUDE_FAMILY_PLAN = `- Match plan depth to task complexity. A single-file edit needs a 5-line spec, not a treatise.
...
export const CLAUDE_FAMILY_EXPLORE = `- Resist over-exploration. Stop when you have the integration points needed to plan, not when you have read every file.
- Trace one call chain end-to-end rather than sampling many shallowly.`

/** Claude family review: decisive, top-N findings only. */
export const CLAUDE_FAMILY_REVIEW = "- Be decisive — call out the top 3–5 issues, not every observation."
...
export const CLAUDE_OPUS_46_PLAN = `- Don't relitigate decisions in build.`
