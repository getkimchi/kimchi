...
export class WebSocketTransport implements Transport {
	...
	close(code?: number, reason?: string): void {
		...
		const WS = (this.ws as any).constructor ?? globalThis.WebSocket
	 ...
	 * @param WS     WebSocket constructor override (defaults to globalThis.WebSocket)
	 */
	static async create(
		url: string,
		...
		const Ctor = WS ?? (globalThis as any).WebSocket
		if (!Ctor) {
