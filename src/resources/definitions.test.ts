...
describe("resource definitions", () => {
	...
	it("surfaces Codex hooks as one disabled extension resource", () => {
		...
		expect(hookResources).not.toContain("hooks.codex.user.session-start.0")
		expect(extensionResources).toContain("extensions.codex-hook-adapter")
		expect(resources.find((resource) => resource.id === "extensions.codex-hook-adapter")).toMatchObject({
