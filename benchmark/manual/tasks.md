...
**Expected:** Auto routing with orchestration, 0–2 subagents, <5 min, tests included, no external deps.
...
**Expected:** Auto routing with orchestration, plan phase (heavy model) + implementation phase (standard model), 1–5 subagents, <10 min, clean layer separation, map-based tests, stdlib only.
